...
CREATE TABLE `entity` (
  ...
  `entity` enum('user','photo','photo_comment') NOT NULL,
...
INSERT INTO `entity` VALUES (1,'user'),(2,'photo'),(3,'photo_comment'),(4,'photo'),(5,'photo'),(6,'photo'),(7,'photo_comment'),(8,'photo_comment'),(9,'photo');
